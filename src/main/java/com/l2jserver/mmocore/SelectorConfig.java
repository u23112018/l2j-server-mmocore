...
public final class SelectorConfig {
	...
	/**
	 * Defines how much time (in milliseconds) should the selector sleep, an higher value increases throughput but also increases latency(to a max of the sleep value itself).<BR>
	 ...
	 * 10-30 for an latency/throughput trade-off based on your needs.
	 */
